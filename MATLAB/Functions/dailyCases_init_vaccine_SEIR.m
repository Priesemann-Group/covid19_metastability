function [Nobs_total,vacc_frac,Imm_frac,ne,ts,Ncrit] = dailyCases_init_vaccine_SEIR(sol,M,xi,tc,tau,nu,Rt,Gamma,lambda_s,lambda_r,eta,epsilon,nmax,Phi0,Phild,t1,t2,D,Rtld,Rtald,phi,lambda_s2,lambda_r2,R0,V)
...
vacc_frac   = trapz(t,dvacdt(t,V))/M;
Imm_frac    = 1-S/M;
